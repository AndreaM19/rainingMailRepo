...
<table class="subscribersList" cellspacing="0">
    ...
    while ($row = mysql_fetch_array($query))	
		...
		<td class='icons'><a href='subscriberList.php?reload=delete&name=".$row['Nome']."&surname=".$row['Cognome']."' onClick='return confirmScreenMessage(\"".$CONFIRM_DELETE_MESSAGE_INIT." ".$row['Nome']." ".$row['Cognome']." ".$CONFIRM_DELETE_MESSAGE_END."\");'><img src='IMG/Icons/delete.png' /></a></td>
